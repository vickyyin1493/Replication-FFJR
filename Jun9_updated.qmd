...
Both components act together and implicitly suggests that the market, being aware of firms' signaling rationales, will be expecting dividends after split snnouncements.  
...
Assuming theory B holds, then the market should react positively when split announced and stays the same afterwards for firms that announced dividend increases and react positively initially and then negatively for firms that annlunced dividend decreases. This is due to the market's expectation that firms announced stock splits will announce dividend increases, and when they are not receiving what's been expected, they would react nagatively as a result. 
