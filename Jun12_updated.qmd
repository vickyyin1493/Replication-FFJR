...
In order to distinguish theory A (liquidity theory) and theory B (signalling theory), dividend would be an important aspect to analyse. 

Theory B suggests that firms use stock splits to signal dividend announcements which in turn may also signal future prospects. There are two components in this theory, one is that stock splits signals dividends and another one is that dividends may signal future prospects.
